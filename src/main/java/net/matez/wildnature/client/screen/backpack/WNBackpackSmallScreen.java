...
@OnlyIn(Dist.CLIENT)
public class WNBackpackSmallScreen extends AbstractContainerScreen<WNBackpackMenuSmall> {
    private static final ResourceLocation CONTAINER_TEXTURE = new ResourceLocation(WildNature.modid, "textures/gui/backpack/backpack_small.png");

    public WNBackpackSmallScreen(WNBackpackMenuSmall menu, Inventory inventory, Component component) {
