package net.matez.wildnature.client.screen.backpack;
...
@OnlyIn(Dist.CLIENT)
public class WNBackpackMediumScreen extends AbstractContainerScreen<WNBackpackMenuMedium> {
    private static final ResourceLocation CONTAINER_TEXTURE = new ResourceLocation(WildNature.modid, "textures/gui/backpack/backpack_medium.png");

    public WNBackpackMediumScreen(WNBackpackMenuMedium menu, Inventory inventory, Component component) {
