...
public class WNICraftingShapeless extends WNIRecipe {
    private String group = null;
    private final ItemStack result;
    private final ShapelessItems shapelessItems;

    public WNICraftingShapeless(String name, ItemStack result, ShapelessItems shapelessItems) {
        super(name);
    ...
    public WNICraftingShapeless(String name, String group, ItemStack result, ShapelessItems shapelessItems){
