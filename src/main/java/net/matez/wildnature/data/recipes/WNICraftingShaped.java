...
public class WNICraftingShaped extends WNIRecipe {
    private String group = null;
    private final String pattern;
    private final ItemStack result;
    private final ShapedItems shapedItems;

    public WNICraftingShaped(String name, String pattern, ItemStack result, ShapedItems shapedItems) {
        super(name);
    ...
    public WNICraftingShaped(String name, String group, String pattern, ItemStack result, ShapedItems shapedItems){
