...
package net.matez.wildnature.common.objects.items.fertilizer;
...
public class WNFertilizerItem extends WNItem {
    public WNFertilizerItem(ResourceLocation location, Properties properties) {
