...
package net.matez.wildnature.common.objects.items.cotton;
...
public class WNCottonItem extends WNItem {
    public WNCottonItem(ResourceLocation location, Properties properties) {
