...
public class WNCaveHangingBushBlock extends WNCaveBushBlock{
    ...
    public WNCaveHangingBushBlock(ResourceLocation location, Properties properties, CavePlantType type) {
        super(location, properties, type);
    }

    public WNCaveHangingBushBlock(ResourceLocation location, Properties properties, Item.Properties itemProperties, CavePlantType type) {
