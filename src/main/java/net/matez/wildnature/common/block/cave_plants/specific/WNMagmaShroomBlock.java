...
public class WNMagmaShroomBlock extends WNCaveBushBlock {
    public WNMagmaShroomBlock(ResourceLocation location, Properties properties, CavePlantType type) {
        super(location, properties, type);
    }

    public WNMagmaShroomBlock(ResourceLocation location, Properties properties, Item.Properties itemProperties, CavePlantType type) {
