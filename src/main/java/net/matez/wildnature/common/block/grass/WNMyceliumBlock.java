...
public class WNMyceliumBlock extends WNAbstractMyceliumBlock {
    private final GrassType grassType;

    public WNMyceliumBlock(ResourceLocation location, Properties properties, GrassType grassType) {
        super(location, properties);
        this.grassType = grassType;
    }

    public WNMyceliumBlock(ResourceLocation location, Properties properties, Item.Properties itemProperties, GrassType grassType) {
    ...
    public WNTags.TagList getWNTags() {
        return new WNTags.TagList(
                ...
                WNTags.BIG_DRIPLEAF_REPLACEABLE, WNTags.MINEABLE_SHOVEL, WNTags.DIRT,
                WNTags.MUSHROOM_GROW_BLOCK, WNTags.MUSHROOMS_SPAWNABLE_ON
        );
    }
}
