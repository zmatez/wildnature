...
public abstract class WNBasePressurePlateBlock extends WNBlock {
   ...
   public WNBasePressurePlateBlock(ResourceLocation location, Properties properties) {
      super(location, properties);
   }

   public WNBasePressurePlateBlock(ResourceLocation location, Properties properties, Item.Properties itemProperties) {
      super(location, properties, itemProperties);
   }

   public WNBasePressurePlateBlock(ResourceLocation location, Properties properties, WNBlockItem item) {
   ...
   public void tick(BlockState p_49304_, ServerLevel p_49305_, BlockPos p_49306_, Random p_49307_) {
      ...
      if (i > 0) {
         this.checkPressed(null, p_49305_, p_49306_, p_49304_, i);
      }
