...
public class WNRockStairBlock extends StairBlock implements WNBlock {
    protected final RockType rockType;
    private final Supplier<Block> fullBlock;

    public WNRockStairBlock(Properties properties, RockType rockType, Supplier<Block> fullBlock) {
