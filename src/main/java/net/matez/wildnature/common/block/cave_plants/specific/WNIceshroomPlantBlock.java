...
public class WNIceshroomPlantBlock extends WNCaveBushBlock {
    public WNIceshroomPlantBlock(ResourceLocation location, Properties properties, CavePlantType type) {
        super(location, properties, type);
    }

    public WNIceshroomPlantBlock(ResourceLocation location, Properties properties, Item.Properties itemProperties, CavePlantType type) {
