...
public class WNGlowshroomPlantBlock extends WNCaveBushBlock {
    public WNGlowshroomPlantBlock(ResourceLocation location, Properties properties, CavePlantType type) {
        super(location, properties, type);
    }

    public WNGlowshroomPlantBlock(ResourceLocation location, Properties properties, Item.Properties itemProperties, CavePlantType type) {
