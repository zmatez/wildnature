...
public class WNStalagmiteBlock extends WNCaveBushBlock {
    public WNStalagmiteBlock(ResourceLocation location, Properties properties, CavePlantType type) {
        super(location, properties, type);
    }

    public WNStalagmiteBlock(ResourceLocation location, Properties properties, Item.Properties itemProperties, CavePlantType type) {
