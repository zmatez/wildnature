...
package net.matez.wildnature.common.item.geyser;

import net.matez.wildnature.common.event.GeyserItemEvent;
...
public class WNGeyserEssenceItem extends WNItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag) {
        ...
        components.add(new TextComponent("Unstable").withStyle(ChatHelper.format(ChatHelper.ACCENT_COLOR)));
    }
}
